...
class Droit
{
    ...
    /**
     * @var \Admin\Entity\Ressource
     *
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="NONE")
     * @ORM\OneToOne(targetEntity="Admin\Entity\Ressource")
     * @ORM\JoinColumns({
     ...
     * Set idclass
     *
     * @param \Admin\Entity\Ressource $idclass
     * @return Droit
     */
    public function setIdclass(\Admin\Entity\Ressource $idclass)
    {
